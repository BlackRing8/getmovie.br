        ...
        <div className="flex h-40 sm:h-80  w-full sm:mb-20 justify-center items-center">
            <div className="flex flex-wrap h-full sm:h-72 w-full ">
                ...
                <div className="flex w-2/3 h-full justify-center items-center">
                    <div className="flex h-28 w-56 sm:h-full sm:w-11/12">
                        <p className="text-cr-6 text-[10px] sm:text-2xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat libero eius autem harum quis dolore officia dolor ipsum possimus ducimus laborum eveniet, voluptate, sunt consequuntur suscipit ab exercitationem blanditiis assumenda illo omnis? Commodi voluptatem tempora laudantium maiores molestiae magni repellendus.</p>
                    </div>
                </div>
            </div>
        </div>
